...
<main class="mx-5">
  <ul class="nav nav-tabs nav-justified mt-5" id="myTab" role="tablist">
    <li class="nav-item">
      <a class="nav-link active show" id="Books Rented" data-toggle="tab"
      href="#curr_rentals" role="tab" aria-controls="curr_rentals"
      aria-selected="true">
        Current Rentals
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" id="Searching" data-toggle="tab" href="#searching"
      role="tab" aria-controls="searching" aria-selected="false">
        Search
      </a>
    </li>
</ul>
